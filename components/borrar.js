        ...
        <>
            ...
            <form style={{ width: '100%', maxWidth: '920px', margin: 'auto' }}>
                ...
                {datosInput.rol == '2' ? <>
                    ...
                    <input className='form-control' name="imgDavi" onChange={(e) => { setFile2(e.target.files[0]) }} type="file" accept='image/*' placeholder="Imagen Davi" />
                    <input className='form-control' name="imgNequi" onChange={(e) => { setFile3(e.target.files[0]) }} type="file" accept='image/*' placeholder="Imagen Nequi" />
                </> : ''}
