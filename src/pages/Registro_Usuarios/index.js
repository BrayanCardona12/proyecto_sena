...
export default function RegistroUsuarios() {
    ...
    let { changeInput, submit, datosInput, error, loading } = logRegister()
    ...
    justify-content: center;
        ...
        .form-register {
          ...
          .btn-send-register {
            ...
            border: none;
            padding: 10px;
            background-color: rgb(87, 221, 92);
            border-radius: 6px;
          }
        ...
        `}
            ...
            <main className='cont-form-register'>
                ...
                <form onSubmit={submit} className="form-register">
                    ...
                    <input onChange={changeInput} value={datosInput.telefono} name="telefono" placeholder="Teléfono" type="number" />
